...
Authors: Rado Kirov
-/
import Submission.SphereTopology.SphereSimplyConnected
import Mathlib.Topology.Subpath
/-!
# Two-open Seifert–van Kampen for `π₁`, and `S²` simply connected (unconditional)

This file discharges the single remaining hypothesis of `Jacobians/SphereTopology/SphereSimplyConnected.lean`:
