...
No `axiom`, no gaps.
-/
import Submission.Discharge.Manifold.ChartedSpaceLocPathConnected
import Submission.Discharge.Manifold.ConnectedManifoldPathConnected
import Submission.Discharge.Manifold.ChartLocalDetour
import Submission.Discharge.Manifold.IsPathConnectedBallMinusCountable
import Submission.Discharge.Manifold.ChartRestrictionToBall
import Submission.Discharge.Manifold.PathSubdivisionByBallCharts
import Submission.Discharge.Manifold.ChartOverlapAvoidanceFull
