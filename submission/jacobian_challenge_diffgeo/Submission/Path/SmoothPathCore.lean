import Submission.Path.CotangentCoeff
import Submission.Path.SmoothPath
/-!
# SmoothPathCore: smoothPath-independent foundations + chart-ball-hop machinery

This module is **upstream of `Jacobians/JacobianConstruction/PeriodLattice.lean`**. It hoists the
...
fields are proved via the building blocks in `Jacobians/Path/SmoothPath.lean`;
