/-
  ...
  * The FA finiteness assembly via `finiteDimensional_h1_of_leray_compact`.
  ...
  axiom-clean).
-/
import Submission.Dolbeault.CechModelHolomorphic
import Submission.Dolbeault.CechModelManifold
import Submission.Dolbeault.DbarDiskCohomology
import Submission.Dolbeault.CechDiskAcyclic
import Submission.Dolbeault.GoodCover
import Submission.Dolbeault.DbarOpenDisk
