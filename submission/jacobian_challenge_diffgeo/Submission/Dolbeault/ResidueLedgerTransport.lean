/-
  ...
  * `continuous_ledgerIntegrand` / `hasCompactSupport_ledgerIntegrand` /
  ...
  coordinate `z_k`").
-/
import Submission.Dolbeault.PlanarHolomorphicChangeOfVariables
import Submission.Dolbeault.AnnulusResidueMeromorphic
import Submission.Dolbeault.MeromorphicAnalyticBadSet
import Submission.Dolbeault.CechModelManifold
