...
(`Jacobians.ProperDegree.ProperMapDegree`), whose existence discharges
...
namespace Jacobians.ProperDegree.ProperMapDegreeConstruct

open Jacobians Jacobians.ProperDegree.ProperMapDegree
...
`ProperMapDegreeData` (`Jacobians.ProperDegree.ProperMapDegree`) needs a locally-constant
...
(`Jacobians.ProperDegree.ProperMapDegree`), the argument-principle equality and hence the
...
end Jacobians.ProperDegree.ProperMapDegreeConstruct
