...
(`Jacobians.ProperDegree.DegDivResidue`) it discharges `exists_properMapDegree`, the keystone
...
namespace Jacobians.ProperDegree.ProperMapDegree
...
end Jacobians.ProperDegree.ProperMapDegree
